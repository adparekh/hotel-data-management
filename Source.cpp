...
void countbycountry(guest g[50], int n) {
  ...
  for (int i = 0; i < n; i++)
    if (strcmp(g[i].cntry, cntry) == 0) count++;
...
void countbyroomtype(guest g[50], int n) {
  ...
  for (int i = 0; i < n; i++)
    if (strcmp(g[i].rmtyp, rmtyp) == 0) count++;
  ...
  for (int i = 0; i < n; i++) {
    if (strcmp(g[i].nm, name) == 0) {
      ...
      if (strcmp(g[i].Bills, "NO") == 0) {
        ...
        cin >> days;
        if (strcmp(g[i].rmtyp, "Single") == 0) net = 100 * days;
        else if (strcmp(g[i].rmtyp, "Double") == 0) net = 200 * days;
        else if (strcmp(g[i].rmtyp, "Queen") == 0) net = 400 * days;
        else if (strcmp(g[i].rmtyp, "King") == 0) net = 500 * days;
        else if (strcmp(g[i].rmtyp, "Deluxe") == 0) net = 750 * days;
        else if (strcmp(g[i].rmtyp, "Master") == 0) net = 1000 * days;
...
void report(guest g[50], int n) {
  ...
  for (int i = 0; i < n; i++) {
    if (strcmp(g[i].rmtyp, "SINGLE") == 0) sing++;
    if (strcmp(g[i].rmtyp, "DOUBLE") == 0) dbl++;
    if (strcmp(g[i].rmtyp, "QUEEN") == 0) quen++;
    if (strcmp(g[i].rmtyp, "KING") == 0) kng++;
    if (strcmp(g[i].rmtyp, "DELUXE") == 0) delx++;
    if (strcmp(g[i].rmtyp, "MASTER") == 0) mstr++;
  }
  system("cls");
...
void feedback() {
  system("cls");
  char name[15], feedback[500];
  int grade, rating;
  fstream f;
  f.open("Feedback.txt", ios::app);

  cout << endl;
  cout << " I hope you liked our Program. " << endl;
  cout << " Name: ";
  cin >> name;
  cout << " Class: ";
  cin >> grade;
  ...
  cin >> rating;
  cout << " Feedback (max 500 char): ";
  cin.get();
  cin.getline(feedback, 500);
  f << name << " of Grade" << grade << " : (" << rating << "/10) " << feedback << endl;
  exit();
}
